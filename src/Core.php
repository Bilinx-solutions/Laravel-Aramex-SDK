...
class Core
{
    ...
    public function __construct($account, $LabelInfo = null)
    {
        ...
        $this->accNum = $account['AccountNumber'];
        $this->accEnt = $account['AccountEntity'];
        $this->accCntryCd = $account['AccountCountryCode'];
        $this->accPin = $account['AccountPin'];
        $this->usrNm = $account['UserName'];
        $this->psrd = $account['Password'];
        $this->ver = $account['Version'];
        $this->param['ClientInfo'] = $account;
    }

    public function initializeShipment($shipper, $consignee, $thirdParty, $details)
    {
        $this->param['Shipments'] = [
            [
                ...
                'ThirdParty' => [
                    ...
                    'PartyAddress'  => [
                        'Line1'                 => $thirdParty->Line1, //Line1 
                        'Line2'                 => $thirdParty->Line2, //Line2 
                        'Line3'                 => $thirdParty->Line3, //Line3
                        'CountryCode'           => $thirdParty->CountryCode, // Country Code
